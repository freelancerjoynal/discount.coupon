                                                ...
                                                <td>
                                                    <div className="flex gap-2">
                                                        <div className="avatar avatar-circle">
                                                            <img
                                                                src="assets/Assets/images/avatar1.png"
                                                                alt="avatar-img"
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="flex gap-2">
                                                        <div className="avatar avatar-circle">
                                                            <img
                                                                src="assets/Assets/images/avatar2.png"
                                                                alt="avatar-img"
                                                                className="avatar-img"
                                                            />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="flex gap-2">
                                                        <div className="avatar avatar-circle">
                                                            <img
                                                                src="assets/Assets/images/avatar3.png"
                                                                alt="avatar-img"
                                                                className="avatar-img"
                                                            />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="flex gap-2">
                                                        <div className="avatar avatar-circle">
                                                            <img
                                                                src="assets/Assets/images/avatar4.png"
                                                                alt="avatar-img"
                                                                className="avatar-img"
                                                            />
                                                        </div>
