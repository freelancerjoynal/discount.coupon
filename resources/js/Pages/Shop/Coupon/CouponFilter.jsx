...
export const CouponFilter = () => {
    ...
    return (
        ...
        >
            <div
                className="relative flex rounded border border-[rgb(253,208,23)] bg-white"
            ...
            >
                ...
                <button
                    className="bg-primary shadow-primary-3 hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 active:shadow-primary-2 dark:hover:shadow-dark-strong  dark:focus:shadow-dark-strong dark:active:shadow-dark-strong relative z-[2] -ms-0.5 flex items-center rounded-e px-5 text-xs font-medium uppercase leading-normal text-black transition duration-150 ease-in-out focus:outline-none focus:ring-0 active:bg-primary-600 dark:shadow-black/30"
                    type="submit"
                    id="button-addon4"
