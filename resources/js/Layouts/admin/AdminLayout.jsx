...
export default function AdminLayout({ user, children }) {
    ...
    return (
        <div>
            ...
            <SidebarComponent />
            {/* content wrapper */}
            <div className="wrapper font-['Varela_Round']">
                {/* <!-- Header Starts --> */}
                <Header user={user} />
                {/* header content */}
                    ...
                    <div className="modal-content">
                        <div className="modal-header px-4 sm:px-6">
                            <div className="group flex items-center">
                                ...
                                />
                                <button
                                    className="rounded-primary bg-slate-100 px-2 py-1 text-[10px] font-semibold text-slate-600 dark:bg-slate-700 dark:text-slate-300"
                                    data-dismiss="modal"
                                >
                                    ESC
                                </button>
